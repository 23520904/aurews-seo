      ...
      <div className="wired-wrapper">
        <div style={{ 
          ...
          <div>
            ...
            <p className="wired-body" style={{ fontSize: '14px', color: 'var(--caption)' }}>
              Next-generation news architecture inspired by editorial excellence and technical precision.
            </p>
          </div>
          <div>
            <h3 className="wired-mono" style={{ fontSize: '12px', marginBottom: 'var(--space-4)', color: 'var(--caption)' }}>Sections</h3>
          ...
          <div>
            <h3 className="wired-mono" style={{ fontSize: '12px', marginBottom: 'var(--space-4)', color: 'var(--caption)' }}>Connect</h3>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 'var(--space-2)' }}>
        ...
        <div style={{ 
          ...
          <span className="wired-mono" style={{ fontSize: '11px', color: 'var(--caption)' }}>© 2026 AUREWS. ALL RIGHTS RESERVED.</span>
          <nav style={{ display: 'flex', gap: 'var(--space-6)' }}>
            <Link href="/privacy" className="wired-mono hover-link" style={{ fontSize: '11px', color: 'var(--caption)' }}>Privacy Policy</Link>
            <Link href="/terms" className="wired-mono hover-link" style={{ fontSize: '11px', color: 'var(--caption)' }}>Terms of Service</Link>
          </nav>
        </div>
      </div>
    </footer>
